...
<div style="padding:60px 0;">
    <div class="container">
        <div style="max-width:900px; margin:auto; background:#fff; border-radius:24px; padding:30px; box-shadow:0 20px 45px rgba(15,23,42,0.08);">
            <h1 style="font-size:32px; margin-bottom:8px;">Create Blog</h1>
            <p style="color:#64748b; margin-bottom:24px;">Add a new blog post using image URL, title, and description.</p>
            ...
            <form action="{{ route('admin.blogs.store') }}" method="POST">
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" placeholder="Enter blog title"
                ...
                <div style="margin-bottom:22px;">
                    ...
                    <textarea name="description" rows="10" placeholder="Write blog description..."
                        style="width:100%; padding:14px 16px; border:1px solid #cbd5e1; border-radius:14px; resize:vertical;">{{ old('description') }}</textarea>
                    @error('description')
                        <div style="color:#dc2626; font-size:13px; margin-top:6px;">{{ $message }}</div>
                    @enderror
                </div>
